...
class AdmUsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_adm_users_clubs1_idx' => ['type' => 'index', 'columns' => ['club_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_adm_users_clubs1' => ['type' => 'foreign', 'columns' => ['club_id'], 'references' => ['clubs', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
'engine' => 'InnoDB', 'collation' => 'utf8_general_ci'
    ...
    public $records = [
        [
            ...
            'created' => '2015-04-07 13:26:14',
            'is_active' => 1,
            'club_id' => 1,
            'modified' => '2015-04-07 13:26:14',
