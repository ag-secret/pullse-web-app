...
class ClubsController extends AppController
{
    ...
    {
        $breadcrumb = ['parent' => 'Localização'];

        $club = $this->Clubs->get($this->Auth->user('club_id'));
        ...
        if ($this->request->is(['patch', 'post', 'put'])) {
            ...
            if ($this->Clubs->save($club)) {
                ...
                $this->Flash->error('Ocorreu um erro ao salvar os seus dados');
            }
        }

        $this->set(compact('club', 'breadcrumb'));
    }
}
