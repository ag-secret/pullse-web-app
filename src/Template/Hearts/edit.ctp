<div class="actions columns col-lg-2 col-md-3">
    ...
    <ul class="nav nav-stacked nav-pills">
        <li class="active disabled"><?= $this->Html->link(__('Edit Heart'), ['action' => 'edit', $heart->id]) ?> </li>
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $heart->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $heart->id), 'class' => 'btn-danger']
            )
        ?></li>
